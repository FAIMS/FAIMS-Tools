...
mkdir -p wireframeImages
  ...
  ./makeElement.sh Control_Main_Object_Starting_ID "Object Starting ID" input 1 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Main_GPS_Diagnostics "GPS Diagnostics" input 1 false false false false true wireframeImages/
  
  ./makeElement.sh Control_Records_Search_Term "Search Term" input 2 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Records_Search "Search" button 2 false false false false false wireframeImages/
  
  ./makeElement.sh Control_Records_Results "Results" list 1 false false false false false wireframeImages/
  ...
  ./makeElement.sh Burial_Mound_General_Site_Significance "Site Significance" dropdown 1 true true true false false wireframeImages/
  ...
  ./makeElement.sh Burial_Mound_General_Lat "Lat" input 2 false false true false false wireframeImages/
  
  ./makeElement.sh Burial_Mound_General_Long "Long" input 2 false false true false false wireframeImages/
  
  ./makeElement.sh Burial_Mound_General_Easting "Easting" input 3 false false true false false wireframeImages/
  
  ./makeElement.sh Burial_Mound_General_Northing "Northing" input 3 false false true false false wireframeImages/
  
  ./makeElement.sh Burial_Mound_General_Northing2 "Northing" input 3 false false true false false wireframeImages/
